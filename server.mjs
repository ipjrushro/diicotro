...
app.use(
    cookieSession({
        ...
        // TLS is terminated by Cloudflare before the request reaches Express.
        // Keeping this false lets cookie-session persist OAuth state through
        // Cloudflare's Node HTTP adapter; the public URL itself remains HTTPS.
        secure: false
    })
);
